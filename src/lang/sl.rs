...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("connecting_status", "Vzpostavljanje povezave z omrežjem App..."),
        ...
        ("install_tip", "Zaradi nadzora uporabniškega računa, App v nekaterih primerih na oddaljeni strani ne deluje pravilno. Temu se lahko izognete z namestitvijo."),
        ("Click to upgrade", "Klikni za nadgradnjo"),
        ("Configure", "Nastavi"),
        ("config_acc", "Za oddaljeni nadzor namizja morate Appu dodeliti pravico za dostopnost"),
        ("config_screen", "Za oddaljeni dostop do namizja morate Appu dodeliti pravico snemanje zaslona"),
        ...
        ("android_input_permission_tip1", "Za oddaljeni nadzor vaše naprave Android, je potrebno Appu dodeliti pravico za dostopnost."),
        ("android_input_permission_tip2", "Pojdite v sistemske nastavitve, poiščite »Nameščene storitve« in vklopite storitev »App Input«."),
        ...
        ("Language", "Jezik"),
        ("Keep App background service", "Ohrani Appovo storitev v ozadju"),
        ("Ignore Battery Optimizations", "Prezri optimizacije baterije"),
        ("android_open_battery_optimizations_tip", "Če želite izklopiti to možnost, pojdite v nastavitve aplikacije App, poiščite »Baterija« in izklopite »Neomejeno«"),
        ...
        ("config_input", "App potrebuje pravico »Nadzor vnosa« za nadzor oddaljenega namizja s tipkovnico."),
        ("config_microphone", "App potrebuje pravico »Snemanje zvoka« za zajemanje zvoka."),
        ...
        ("verify_app_password_tip", "Preveri geslo za App"),
        ...
        ("scam_text1", "V primeru, da vas je nekdo, ki ga ne poznate in mu zaupate prosil, da uporabite App, prekinite klic in program zaprite."),
        ("scam_text2", "App omogoča popoln nadzor nad vašim računalnikom in telefonom, in se lahko uporabi za krajo vašega denarja ali pa zasebnih podatkov."),
        ...
        ("upgrade_app_server_pro_to_{}_tip", "Prosimo, nadgradite App Server Pro na različico {} ali novejšo."),
        ...
        ("powered_by_me", "Uporablja tehnologijo App"),
        ...
        ("allow-only-conn-window-open-tip", "Dovoli povezavo samo če je okno Appa odprto"),
        ...
        ("floating_window_tip", "Pomaga pri App storitvi v ozadju"),
        ...
        ("Accessible devices", ""),
        ("upgrade_remote_app_client_to_{}_tip", "Prosimo, nadgradite App odjemalec na različico {} ali novejšo na oddaljeni strani."),
        ("d3d_render_tip", ""),
        ("Use D3D rendering", ""),
        ("Printer", ""),
