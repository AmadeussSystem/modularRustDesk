...
class InputModel {
  ...
  static void initSideButtonChannel() {
    ...
    const channel = MethodChannel('org.app.app/side_buttons');
  ...
  void onPointHoverImage(PointerHoverEvent e) {
    ...
    // May fix https://github.com/app/app/issues/13009
  ...
  static Future<Rect?> fillRemoteCoordsAndGetCurFrame(
    ...
    final coords =
        await appWinManager.getOtherRemoteWindowCoordsFromMain();
  ...
  static Point<double>? getPointInRemoteRect(
    ...
    // https://github.com/app/app/issues/6678
