...
class FfiModel with ChangeNotifier {
  ...
  bool shouldAutoRetryOnOffline(
    ...
    if (type == 'error' &&
      ...
      // https://github.com/app/app/discussions/14048
  ...
  handlePlatformAdditions(
    ...
    if (updateData.isEmpty) {
      _pi.platformAdditions.remove(kPlatformAdditionsAppVirtualDisplays);
      ...
      try {
        ...
        if (!updateJson
            .containsKey(kPlatformAdditionsAppVirtualDisplays)) {
          _pi.platformAdditions
              .remove(kPlatformAdditionsAppVirtualDisplays);
        }
  ...
  void setViewOnly(String id, bool value) {
    ...
    // tmp fix for https://github.com/app/app/pull/3706#issuecomment-1481242389
  ...
  void edgeScrollMouse(double x, double y) async {
    ...
    if (encroachment.length2 == 0) {
      ...
      var bumpMouseSucceeded = _bumpMouseIsWorking &&
          (await appWinManager.call(WindowType.Main, kWindowBumpMouse,
...
class PeerInfo with ChangeNotifier {
  ...
  List<int> get AppVirtualDisplays => List<int>.from(
      platformAdditions[kPlatformAdditionsAppVirtualDisplays] ?? []);
  ...
  bool get isAppIdd =>
      platformAdditions[kPlatformAdditionsIddImpl] == 'app_idd';
