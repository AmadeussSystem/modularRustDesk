...
class AppMultiWindowManager {
  AppMultiWindowManager._();

  static final instance = AppMultiWindowManager._();
  ...
  /// `appWinManager.call(WindowType.Main, kWindowEventHide, {"id": windowId!});`
...
final appWinManager = AppMultiWindowManager.instance;
